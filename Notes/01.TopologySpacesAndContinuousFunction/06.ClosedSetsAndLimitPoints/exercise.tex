...
\begin{enumerate}
      ...
      \item A \defineNewWorld{diagonal}\label{def:Diagonal} is a subset \mt{
      ...
      \item If \mt{A \subseteq \mathbb{X}}, we define the \defineNewWorld{boundary}\label{def:Boundary} of \mt{A} by the equation
      \begin{equation*}
